...
export const HALITE_CAPABILITIES = [
  {
    label: 'Living Consumer Profiles',
    desc: 'AI-driven profiles built in under two minutes that update in real time — so you always know who your customer is, not just what they last bought.',
  },
  {
    label: 'Predictive Retention',
    desc: 'Surfaces churn risk and reorder intent before you lose the sale. Halite delivers an average 30% retention lift across CPG brands on the platform.',
  },
  {
    label: 'Brand Intelligence Dashboard',
    desc: 'Aggregate consumer signals across your full customer base — satisfaction, engagement, and conversion data in one unified view.',
  },
];
